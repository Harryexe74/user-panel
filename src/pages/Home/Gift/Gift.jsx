...
// import products from '../../../components/common/Data/products';
// import { Link } from 'react-router-dom';
// import { FaArrowRight, FaEye } from 'react-icons/fa';
// import './GiftSection.css';

// const CardRow = () => {
//   // Limit the number of cards to a maximum of 6
//   const limitedCardData = products.slice(0, 6);
...
//           See Our Huge Range of Gifts to Suit All Health
//         </h1>

//         {/* Card Row */}
//         <div className="flex flex-wrap justify-center gap-4">
//           {limitedCardData.map((card, index) => (
//             <div key={index} className="relative group overflow-hidden category">
  ...
  return (
    <div className="container p-8">
      <div className="flex flex-col items-center space-y-6 p-6">
        {/* Title */}
        <h1 className="heading">
          {/* See Our Huge Range of Solar to Suit Al Conditions */}
            See Our Huge Range of Solar to Suit All Conditions
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {limitedCategoryData.map((category) => (
            <div key={category._id} className="relative group overflow-hidden category">
              <div className="relative transition-transform duration-300 group-hover:scale-110 rounded-lg overflow-hidden">
                <CardComponent
                  imageSrc={`http://localhost:3000/uploads/${category.logo}`} // Adjust the image path as needed
                  title={category.name}
                />
                {/* Hover effect */}
                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg">
